!function(){
  ...
  viz.bP = function(){
	  var key_scale, value_scale
		,keyPrimary, keySecondary, value, value2
	  ...
	  bP.value2 = function(_){ 
		if(!arguments.length) return typeof value2!== "undefined" ? value2 : function(d){ return d[3]; };
		value2 = _;
		return bP;		
	  }	  	  
	  bP.width = function(_){
	  ...
	  bP.bars = function(mb){
		...
		function calculateMainBars(part){
				;
			function v(d){ return part=="primary"? bP.value()(d): bP.value2()(d);};
