...
class Ref(models.Model):
    ...
    nom = models.TextField(blank=True, null=True)
    club = models.TextField(blank=True, null=True)
    entraineur = models.FloatField(blank=True, null=True)
    t_id = models.FloatField(blank=True, null=True)
    last_tw = models.DateTimeField(blank=True, null=True)
...
class RefClub(models.Model):
    index = models.BigIntegerField(blank=True, null=True)
    club = models.TextField(db_column='Club', blank=True, null=True)  # Field name made lowercase.
    real_club = models.TextField(db_column='Real_club', blank=True, null=True)  # Field name made lowercase.
